...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBFS_1_Not_Supported
;
;  DESCRIPTION:
;
;-----------------------------------------------------------------------------
...
export  USBFS_1_CB_d2h_std_dev_00
USBFS_1_CB_d2h_std_dev_00:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_01 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_dev_01
USBFS_1_CB_d2h_std_dev_01:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_02 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_dev_02
USBFS_1_CB_d2h_std_dev_02:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_03 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_dev_03
USBFS_1_CB_d2h_std_dev_03:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_04 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_dev_04
USBFS_1_CB_d2h_std_dev_04:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_05 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_dev_05
USBFS_1_CB_d2h_std_dev_05:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_06 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_dev_06
USBFS_1_CB_d2h_std_dev_06:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_07 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_dev_07
USBFS_1_CB_d2h_std_dev_07:
ENDIF
...
export  USBFS_1_CB_h2d_std_dev_00
USBFS_1_CB_h2d_std_dev_00:
ENDIF
...
export  USBFS_1_CB_h2d_std_dev_02
USBFS_1_CB_h2d_std_dev_02:
ENDIF
...
export  USBFS_1_CB_h2d_std_dev_04
USBFS_1_CB_h2d_std_dev_04:
ENDIF
...
export  USBFS_1_CB_h2d_std_dev_06
USBFS_1_CB_h2d_std_dev_06:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_07 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_h2d_std_dev_07
USBFS_1_CB_h2d_std_dev_07:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_08 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_h2d_std_dev_08
USBFS_1_CB_h2d_std_dev_08:
ENDIF
...
export  USBFS_1_CB_d2h_std_ifc_01
USBFS_1_CB_d2h_std_ifc_01:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_02 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_ifc_02
USBFS_1_CB_d2h_std_ifc_02:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_03 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_ifc_03
USBFS_1_CB_d2h_std_ifc_03:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_04 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_ifc_04
USBFS_1_CB_d2h_std_ifc_04:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_05 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_ifc_05
USBFS_1_CB_d2h_std_ifc_05:
ENDIF
...
export  USBFS_1_CB_d2h_std_ifc_07
USBFS_1_CB_d2h_std_ifc_07:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_08 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_ifc_08
USBFS_1_CB_d2h_std_ifc_08:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_09 & USB_NOT_SUPPORTED)
export  USBFS_1_CB_d2h_std_ifc_09
USBFS_1_CB_d2h_std_ifc_09:
ENDIF
...
export  USBFS_1_CB_h2d_std_ifc_00
USBFS_1_CB_h2d_std_ifc_00:
ENDIF
...
export  USBFS_1_CB_h2d_std_ep_00
USBFS_1_CB_h2d_std_ep_00:
ENDIF
...
export  USBFS_1_CB_h2d_std_ep_02
USBFS_1_CB_h2d_std_ep_02:
ENDIF
...
export  USBFS_1_Not_Supported
export _USBFS_1_Not_Supported
USBFS_1_Not_Supported:
_USBFS_1_Not_Supported:
   MOV    A, 0                         ; Count 0
   MOV    X, USB_MODE_STALL_IN_OUT     ; Stall the request
   LJMP   USBFS_1_EP0_UPD_MODE_EXIT
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBFS_1_CB_d2h_std_dev_00
;
...
GetStatusTransferDescrTable:
    ...
    TD_ENTRY    USB_DS_RAM, 2, USBFS_1_TransferBuffer, NULL_PTR  ; Intermediate Buffer
.ENDLITERAL
export  USBFS_1_CB_d2h_std_dev_00
USBFS_1_CB_d2h_std_dev_00:
    ...
    MOV     [USBFS_1_TransferBuffer], [USBFS_1_DeviceStatus]
...
ENDIF
;-----------------------------------------------------------------------------
; FUNCTION NAME: USBFS_1_CB_d2h_std_dev_06
;
...
;-----------------------------------------------------------------------------
    MOV     A, REG[USBFS_1_EP0DATA+wValueHi] ; Get the descrptor type
