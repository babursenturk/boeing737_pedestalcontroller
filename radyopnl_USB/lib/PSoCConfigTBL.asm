...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[08h], 50h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], afh		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
...
;  Global Register values
	mov	reg[60h], 01h		; AnalogColumnInputSelect register (AMX_IN)
...
;       Instance name Counter16_1, Block Name CNTR16_LSB(DCB02)
	mov	reg[2bh], 00h		;Counter16_1_CONTROL_LSB_REG(DCB02CR0)
	mov	reg[29h], fah		;Counter16_1_PERIOD_LSB_REG(DCB02DR1)
	mov	reg[2ah], fdh		;Counter16_1_COMPARE_LSB_REG(DCB02DR2)
;       Instance name Counter16_1, Block Name CNTR16_MSB(DCB03)
	mov	reg[2fh], 00h		;Counter16_1_CONTROL_MSB_REG(DCB03CR0)
	mov	reg[2dh], ffh		;Counter16_1_PERIOD_MSB_REG(DCB03DR1)
	mov	reg[2eh], 7fh		;Counter16_1_COMPARE_MSB_REG(DCB03DR2)
;  Instance name I2CHW_1, User Module I2CHW
;  Instance name USBFS_1, User Module USBFS
	M8C_SetBank1
;  Global Register values
...
;  Instance name Counter16_1, User Module Counter16
;       Instance name Counter16_1, Block Name CNTR16_LSB(DCB02)
	mov	reg[28h], 01h		;Counter16_1_FUNC_LSB_REG(DCB02FN)
	mov	reg[29h], 11h		;Counter16_1_INPUT_LSB_REG(DCB02IN)
	mov	reg[2ah], 40h		;Counter16_1_OUTPUT_LSB_REG(DCB02OU)
;       Instance name Counter16_1, Block Name CNTR16_MSB(DCB03)
	mov	reg[2ch], 21h		;Counter16_1_FUNC_MSB_REG(DCB03FN)
	mov	reg[2dh], 31h		;Counter16_1_INPUT_MSB_REG(DCB03IN)
	mov	reg[2eh], 40h		;Counter16_1_OUTPUT_MSB_REG(DCB03OU)
;  Instance name I2CHW_1, User Module I2CHW
;  Instance name USBFS_1, User Module USBFS
	M8C_SetBank0
	ret
