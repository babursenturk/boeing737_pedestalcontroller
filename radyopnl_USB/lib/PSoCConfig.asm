...
export LoadConfig_usb
export _LoadConfig_usb
...
;---------------------------------------------------------------------------
; Load Configuration usb
;
;    Load configuration registers for usb.
...
_LoadConfig_usb:
 LoadConfig_usb:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_usb            ; Call load config table routine
